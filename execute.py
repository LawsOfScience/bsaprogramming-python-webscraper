import sys
import os
from handlers import log, zip, config, package_install as pkg
log.info("Checking for external modules...")
try:
    import requests
except ModuleNotFoundError:
    log.error("Required module \"requests\" not found. Attempting to install.")
